<?php
//000000000120s:7119:"<html>
<meta charset="utf8" />
<body></br>
https://api-develop.migang.com
https://apitest.migang.com
https://apiproduct.migang.com
action="/test.php"
<form id="form1" action="http://test.com/index.php/index.php/Home/Index/mgapp" method="post">
<p>测试表单                             当前提交地址：<span id="currentActionUrl" style ="color:red">https://api-develop.migang.com</span></p> 
<input type="submit" value="提交" />
提交地址：
 <input type="text" name='actionUrl' id="actionUrl" value="https://api-develop.migang.com" size=50 x-webkit-speech/>
 <input type="button" onclick="changeAction()" value="更改提交地址" />
<hr/>
getInput:
<input type="text" name="getInput" value = '' />
web_test:
<input type="text" name="web_test" value ='1' />
migangtype:
<input type="text" name="migangtype" value="0601" />
userid
<input type="text" name="userid" value="12603"/>
udid
<input type="text" name="udid" value="111" />
phonenum:
<input type="text" name="phonenum" value="13910625490" /></br>
paypassword:
<input type="text" name="paypassword"  value = "e0c10f451217b93f76c2654b2b729b85"/>
realdata:
<input type="text" name="realdata" value="1" />
type
<input type="text" name="type"  value="1" />
protype
<input type="text" name="protype"  value="1" />
proid:
<input type="text" name="proid"  value="" /><br/>
money:
<input type="text" name="money"  value="100" />
bankid
<input type="text" name="bankid"  value="01039999" />
banknum:
<input type="text" name="banknum" value="6217920601062305" /></br>
name:
<input type="text" name="name" value="邓翔" />
idcard:
<input type="text" name="idcard" value="360402197104020013" />
 isbang
<input type="text" name="isbang" value="" />
 paytype
<input type="text" name="paytype" value="1" />
act:
<input type="text" name="act" value="" />
investid
<input type="text" name="investid" value="" />
borrow_id
<input type="text" name="borrow_id" value="38" />
paypasswd
<input type="text" name="paypasswd" value="111aaa" />
payjine
<input type="text" name="payjine" value="100000" />
province
<input type="text" name="province" value="0011" />
city
<input type="text" name="city" value="1100" />
token
...
var urlArrIndex = 0;
var urlArr = ['https://api-develop.migang.com','https://apitest.migang.com','https://apiproduct.migang.com','https://web3.migang.com/ajax/payment_huoqi.php'];
