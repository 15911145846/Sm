 ...
 */
require_once PWD."/Home/Lib/ORG/PHPExcel.php";
require_once PWD.'/Home/Lib/ORG/PHPExcel/IOFactory.php';
require_once PWD.'/Home/Lib/ORG/PHPExcel/Reader/Excel5.php';
require_once PWD.'/Home/Lib/ORG/PHPExcel/Reader/Excel2007.php';
Class ExcelImport{
	/**
	*读取excel文件并把内容转换成数组
	*/
